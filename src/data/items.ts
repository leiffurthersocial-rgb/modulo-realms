...
export const OFFHANDS: ItemTemplate[] = [
  ...
  { id: 'shield_gloam', name: 'Gloamwood Roundshield', type: 'armor', slot: 'offHand', icon: 'shield', weaponKind: 'shield', metal: '#1f2a1e', accent: PAL.leafLit, rarity: 'epic', level: 33, value: 4200, stats: { defense: 92, maxHealth: 230, moveSpeed: -3 } },
  { id: 'orb_salt', name: 'Saltglass Lens', type: 'armor', slot: 'offHand', icon: 'orb', weaponKind: 'orb', metal: '#9fc0c8', glow: PAL.foam, rarity: 'epic', level: 42, value: 7600, stats: { abilityPower: 42, maxMana: 150, cooldownReduction: 9 } },
  { id: 'shield_drowned', name: 'The Door They Shut', type: 'armor', slot: 'offHand', icon: 'shield', weaponKind: 'shield', metal: '#38505a', accent: PAL.foam, rarity: 'epic', level: 48, value: 11000, stats: { defense: 138, maxHealth: 360, moveSpeed: -5 }, fixedEnchants: [{ id: 'thorns', level: 3 }], desc: 'From the inside. It held.' },
  { id: 'tome_fen', name: 'The Waterlogged Register', type: 'armor', slot: 'offHand', icon: 'tome', weaponKind: 'tome', metal: '#243330', glow: '#8fd0f0', rarity: 'epic', level: 55, value: 15000, stats: { maxMana: 300, intelligence: 26, abilityPower: 52, cooldownReduction: 12 } },
  { id: 'lantern_storm', name: 'The Earthed Lamp', type: 'armor', slot: 'offHand', icon: 'lantern', metal: '#5a5480', glow: '#b9b0ff', rarity: 'epic', level: 61, value: 19000, stats: { magicFind: 34, maxHealth: 300, critChance: 7 }, desc: 'Braided to the ground with copper. It has been struck and it is still lit.' },
  { id: 'orb_storm', name: 'The Eye of the Flats', type: 'armor', slot: 'offHand', icon: 'orb', weaponKind: 'orb', metal: '#9a8fe8', glow: '#e0dcff', rarity: 'legendary', level: 66, value: 26000, stats: { abilityPower: 76, maxMana: 380, cooldownReduction: 15, intelligence: 22 } },
  { id: 'shield_ember', name: 'The Banked Door', type: 'armor', slot: 'offHand', icon: 'shield', weaponKind: 'shield', metal: '#3a1210', accent: PAL.flameLit, glow: PAL.ember, rarity: 'legendary', level: 72, value: 34000, stats: { defense: 210, maxHealth: 620, strength: 18, moveSpeed: -4 }, fixedEnchants: [{ id: 'thorns', level: 3 }], desc: 'Warm to the touch, on the side facing away from the fire.' },
];
