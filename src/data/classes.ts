...
export const CLASSES: ClassDef[] = [
  ...
  },
  {
    ...
    abilities: [
      ...
      { id: 'mend', name: 'Mend', desc: 'Restore 30% of your maximum health instantly. Ability power improves it, up to 62%.', shape: 'heal', level: 3, mana: 30, stamina: 0, cooldown: 14, power: 2.2, element: 'holy', color: '#f6bf5d', icon: 'potion_health' },
