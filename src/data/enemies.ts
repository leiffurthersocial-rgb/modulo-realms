...
export const ENEMIES: EnemyDef[] = [
  /* --- beasts --- */
  {
    ...
    role: 'standard',
    level: 1, health: 36, damage: 8, defense: 2, speed: 92, xp: 12, gold: [1, 2], radius: 13,
  ...
  },
  {
    ...
    role: 'standard',
    level: 6, health: 83, damage: 21, defense: 9, speed: 104, xp: 48, gold: [5, 12], radius: 16,
  ...
  },
  {
    ...
    role: 'skirmisher',
    level: 11, health: 129, damage: 35, defense: 9, speed: 108, xp: 116, gold: [7, 17], radius: 16,
  ...
  },
  {
    ...
    role: 'standard',
    level: 3, health: 46, damage: 13, defense: 5, speed: 84, xp: 22, gold: [2, 6], radius: 15,
  ...
  },
  {
    ...
    role: 'standard',
    level: 2, health: 40, damage: 10, defense: 3, speed: 88, xp: 16, gold: [2, 4], radius: 13,
  ...
  },
  {
    ...
    role: 'standard',
    level: 8, health: 122, damage: 27, defense: 12, speed: 92, xp: 73, gold: [7, 16], radius: 15,
  ...
  },
  {
    ...
    role: 'skirmisher',
    level: 2, health: 24, damage: 10, defense: 2, speed: 118, xp: 15, gold: [1, 3], radius: 11,
  ...
  },
  {
    ...
    role: 'standard',
    level: 7, health: 100, damage: 24, defense: 11, speed: 78, xp: 60, gold: [6, 14], radius: 15,
  ...
  },
  {
    ...
    role: 'skirmisher',
    level: 6, health: 51, damage: 21, defense: 5, speed: 96, xp: 46, gold: [4, 8], radius: 14,
  ...
  /* --- slimes, spirits, constructs --- */
  {
    ...
    role: 'brute',
    level: 1, health: 79, damage: 9, defense: 2, speed: 52, xp: 14, gold: [1, 3], radius: 13,
  ...
  },
  {
    ...
    role: 'standard',
    level: 7, health: 100, damage: 24, defense: 11, speed: 58, xp: 60, gold: [6, 14], radius: 15,
  ...
  },
  {
    ...
    role: 'skirmisher',
    level: 5, health: 41, damage: 19, defense: 4, speed: 86, xp: 36, gold: [3, 7], radius: 12,
  ...
  },
  {
    ...
    role: 'skirmisher',
    level: 10, health: 110, damage: 32, defense: 8, speed: 92, xp: 99, gold: [6, 15], radius: 12,
  ...
  },
  {
    ...
    role: 'standard',
    level: 4, health: 55, damage: 16, defense: 6, speed: 96, xp: 29, gold: [3, 8], radius: 13,
  ...
  },
  {
    ...
    role: 'skirmisher',
    level: 9, health: 92, damage: 29, defense: 7, speed: 82, xp: 83, gold: [6, 13], radius: 14,
  ...
  },
  {
    ...
    role: 'brute',
    level: 10, health: 358, damage: 36, defense: 24, speed: 52, xp: 120, gold: [13, 31], radius: 18,
  ...
  },
  {
    ...
    role: 'standard',
    level: 12, health: 238, damage: 37, defense: 18, speed: 54, xp: 141, gold: [12, 27], radius: 18,
  ...
  },
  {
    ...
    role: 'standard',
    level: 8, health: 122, damage: 27, defense: 12, speed: 62, xp: 73, gold: [7, 16], radius: 16,
  ...
  /* --- humanoids --- */
  {
    ...
    role: 'standard',
    level: 3, health: 46, damage: 13, defense: 5, speed: 84, xp: 22, gold: [2, 6], radius: 13,
  ...
  },
  {
    ...
    role: 'standard',
    level: 4, health: 55, damage: 16, defense: 6, speed: 88, xp: 29, gold: [3, 8], radius: 13,
  ...
  },
  {
    ...
    role: 'brute',
    level: 7, health: 212, damage: 27, defense: 17, speed: 74, xp: 69, gold: [9, 20], radius: 15,
  ...
  },
  {
    ...
    role: 'standard',
    level: 5, health: 67, damage: 19, defense: 8, speed: 70, xp: 38, gold: [4, 10], radius: 13,
  ...
  },
  {
    ...
    role: 'skirmisher',
    level: 7, health: 62, damage: 24, defense: 6, speed: 66, xp: 57, gold: [4, 10], radius: 13,
  ...
  },
  {
    ...
    role: 'standard',
    level: 2, health: 40, damage: 10, defense: 3, speed: 96, xp: 16, gold: [2, 4], radius: 12,
  ...
  },
  {
    ...
    role: 'skirmisher',
    level: 6, health: 51, damage: 21, defense: 5, speed: 78, xp: 46, gold: [4, 8], radius: 12,
  ...
  },
  {
    ...
    role: 'standard',
    level: 9, health: 146, damage: 29, defense: 14, speed: 80, xp: 88, gold: [8, 19], radius: 15,
  ...
  },
  {
    ...
    role: 'skirmisher',
    level: 11, health: 129, damage: 35, defense: 9, speed: 84, xp: 116, gold: [7, 17], radius: 13,
  ...
  },
  {
    ...
    role: 'standard',
    level: 13, health: 274, damage: 40, defense: 20, speed: 72, xp: 162, gold: [13, 30], radius: 16,
  ...
  /* --- minibosses --- */
  {
    ...
    role: 'elite',
    level: 8, health: 581, damage: 27, defense: 22, speed: 84, xp: 219, gold: [28, 65], radius: 16,
  ...
  },
  {
    ...
    role: 'elite',
    level: 9, health: 695, damage: 29, defense: 24, speed: 78, xp: 263, gold: [32, 75], radius: 22,
  ...
  },
  {
    ...
    role: 'elite',
    level: 12, health: 1103, damage: 37, defense: 32, speed: 56, xp: 423, gold: [46, 108], radius: 24,
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    role: 'skirmisher',
    level: 20, health: 412, damage: 59, defense: 17, speed: 122, xp: 332, gold: [17, 39], radius: 17,
  ...
  },
  {
    ...
    role: 'standard',
    level: 21, health: 686, damage: 62, defense: 32, speed: 70, xp: 382, gold: [26, 60], radius: 16,
  ...
  },
  {
    ...
    role: 'skirmisher',
    level: 22, health: 505, damage: 64, defense: 18, speed: 96, xp: 395, gold: [19, 45], radius: 15,
  ...
  },
  {
    ...
    role: 'standard',
    level: 22, health: 755, damage: 64, defense: 33, speed: 88, xp: 416, gold: [28, 64], radius: 19,
  ...
  },
  {
    ...
    role: 'standard',
    level: 23, health: 823, damage: 67, defense: 35, speed: 94, xp: 452, gold: [30, 69], radius: 14,
  ...
  },
  {
    ...
    scale: 1.45,
    role: 'brute',
    level: 24, health: 1720, damage: 78, defense: 58, speed: 62, xp: 562, gold: [46, 108], radius: 22,
  ...
  },
  {
    ...
    role: 'skirmisher',
    level: 25, health: 658, damage: 73, defense: 21, speed: 74, xp: 501, gold: [24, 56], radius: 14,
  ...
  },
  {
    ...
    role: 'brute',
    level: 26, health: 2016, damage: 84, defense: 62, speed: 52, xp: 653, gold: [53, 123], radius: 25,
  ...
  },
  {
    ...
    scale: 1.8,
    role: 'brute',
    level: 28, health: 2323, damage: 90, defense: 67, speed: 60, xp: 751, gold: [60, 140], radius: 27,
  ...
  },
  {
    ...
    role: 'brute',
    level: 29, health: 2477, damage: 93, defense: 70, speed: 50, xp: 802, gold: [64, 149], radius: 28,
  ...
  /* --- the Gloaming (west, 16-26) --- */
  {
    ...
    role: 'skirmisher',
    level: 17, health: 297, damage: 51, defense: 14, speed: 126, xp: 247, gold: [13, 30], radius: 17,
  ...
  },
  {
    ...
    role: 'standard',
    level: 19, health: 563, damage: 56, defense: 29, speed: 92, xp: 318, gold: [22, 51], radius: 18,
  ...
  },
  {
    ...
    role: 'brute',
    level: 22, health: 1459, damage: 72, defense: 53, speed: 54, xp: 478, gold: [40, 93], radius: 26,
  ...
  },
  {
    ...
    role: 'standard',
    level: 24, health: 899, damage: 70, defense: 36, speed: 96, xp: 489, gold: [32, 74], radius: 14,
  ...
  /* --- the Saltreach (east, 18-28) --- */
  {
    ...
    role: 'standard',
    level: 19, health: 563, damage: 56, defense: 29, speed: 98, xp: 318, gold: [22, 51], radius: 17,
  ...
  },
  {
    ...
    role: 'skirmisher',
    level: 21, health: 459, damage: 62, defense: 17, speed: 104, xp: 363, gold: [18, 42], radius: 15,
  ...
  },
  {
    ...
    role: 'standard',
    level: 23, health: 823, damage: 67, defense: 35, speed: 76, xp: 452, gold: [30, 69], radius: 16,
  ...
  },
  {
    ...
    role: 'brute',
    level: 26, health: 2016, damage: 84, defense: 62, speed: 54, xp: 653, gold: [53, 123], radius: 25,
  ...
  /* --- the Cinderwastes (south, 20-32) --- */
  {
    ...
    role: 'skirmisher',
    level: 21, health: 459, damage: 62, defense: 17, speed: 118, xp: 363, gold: [18, 42], radius: 14,
  ...
  },
  {
    ...
    role: 'standard',
    level: 23, health: 823, damage: 67, defense: 35, speed: 96, xp: 452, gold: [30, 69], radius: 18,
  ...
  },
  {
    ...
    role: 'standard',
    level: 26, health: 1057, damage: 75, defense: 39, speed: 100, xp: 568, gold: [36, 85], radius: 19,
  ...
  },
  {
    ...
    level: 28, health: 2323, damage: 90, defense: 67, speed: 76, xp: 751, gold: [60, 140], radius: 20,
  ...
  },
  {
    ...
    role: 'brute',
    level: 31, health: 2832, damage: 99, defense: 74, speed: 52, xp: 911, gold: [72, 168], radius: 27,
  ...
  /* --- northern elites --- */
  {
    ...
    scale: 1.5,
    role: 'elite',
    level: 24, health: 3844, damage: 70, defense: 65, speed: 68, xp: 1467, gold: [127, 297], radius: 20,
  ...
  },
  {
    ...
    role: 'elite',
    level: 28, health: 5142, damage: 81, defense: 76, speed: 82, xp: 1959, gold: [166, 386], radius: 26,
  ...
  /* --- The Drowning Reach --- */
  {
    ...
    level: 53, health: 3395, damage: 148, defense: 44, speed: 128, xp: 2111, gold: [101, 235], radius: 17,
  ...
  },
  {
    ...
    role: 'skirmisher', region: 'sunkenwest',
    level: 54, health: 3534, damage: 151, defense: 45, speed: 116, xp: 2189, gold: [105, 245], radius: 16,
  ...
  },
  {
    ...
    level: 55, health: 4951, damage: 154, defense: 83, speed: 96, xp: 2388, gold: [156, 364], radius: 19,
  ...
  },
  {
    ...
    level: 57, health: 9303, damage: 178, defense: 137, speed: 52, xp: 2944, gold: [244, 570], radius: 27,
  ...
  },
  {
    ...
    role: 'standard', region: 'sunkenwest',
    level: 59, health: 5732, damage: 164, defense: 89, speed: 82, xp: 2738, gold: [182, 424], radius: 14,
  ...
  },
  {
    ...
    role: 'brute', region: 'sunkenwest',
    level: 61, health: 10659, damage: 190, defense: 146, speed: 50, xp: 3360, gold: [284, 662], radius: 29,
  ...
  /* --- The Stormreach --- */
  {
    ...
    level: 59, health: 4309, damage: 164, defense: 49, speed: 134, xp: 2601, gold: [127, 297], radius: 14,
  ...
  },
  {
    ...
    level: 62, health: 10980, damage: 193, defense: 149, speed: 58, xp: 3468, gold: [294, 686], radius: 29,
  ...
  },
  {
    ...
    level: 64, health: 6811, damage: 178, defense: 96, speed: 118, xp: 3209, gold: [218, 508], radius: 20,
  ...
  },
  {
    ...
    role: 'standard', region: 'stormeast',
    level: 66, health: 7263, damage: 183, defense: 99, speed: 126, xp: 3408, gold: [233, 544], radius: 18,
  ...
  },
  {
    ...
    role: 'standard', region: 'stormeast',
    level: 67, health: 7477, damage: 186, defense: 101, speed: 84, xp: 3510, gold: [241, 563], radius: 14,
  ...
  /* --- The Emberdeep --- */
  {
    ...
    level: 66, health: 5562, damage: 183, defense: 54, speed: 130, xp: 3238, gold: [163, 381], radius: 16,
  ...
  },
  {
    ...
    level: 65, health: 12062, damage: 202, defense: 156, speed: 54, xp: 3804, gold: [327, 763], radius: 30,
  ...
  },
  {
    ...
    level: 67, health: 7477, damage: 186, defense: 101, speed: 104, xp: 3510, gold: [241, 563], radius: 21,
  ...
  },
  {
    ...
    role: 'standard', region: 'emberdeep',
    level: 69, health: 7951, damage: 191, defense: 104, speed: 112, xp: 3718, gold: [258, 602], radius: 21,
  ...
  },
  {
    ...
    role: 'standard', region: 'emberdeep',
    level: 71, health: 8440, damage: 197, defense: 107, speed: 88, xp: 3932, gold: [275, 642], radius: 15,
  ...
  },
  {
    ...
    role: 'brute', region: 'emberdeep',
    level: 73, health: 15178, damage: 226, defense: 175, speed: 48, xp: 4775, gold: [425, 992], radius: 33,
  ...
  /* --- named things in the corridors --- */
  {
    ...
    level: 58, health: 20925, damage: 162, defense: 157, speed: 82, xp: 7944, gold: [701, 1635], radius: 27,
  ...
  },
  {
    ...
    level: 65, health: 26105, damage: 181, defense: 176, speed: 78, xp: 9923, gold: [902, 2104], radius: 16,
  ...
  },
  {
    ...
    level: 72, health: 31956, damage: 199, defense: 194, speed: 96, xp: 12123, gold: [1136, 2651], radius: 30,
...
export const BOSSES: EnemyDef[] = [
  {
    ...
    role: 'boss',
    level: 10, health: 3230, damage: 37, defense: 26, speed: 50, xp: 780, gold: [146, 341], radius: 30,
  ...
  },
  {
    ...
    scale: 2.2,
    role: 'boss',
    level: 15, health: 6481, damage: 52, defense: 38, speed: 74, xp: 1558, gold: [249, 581], radius: 28,
  ...
  },
  {
    ...
    role: 'boss',
    level: 13, health: 5031, damage: 46, defense: 33, speed: 58, xp: 1213, gold: [205, 478], radius: 30,
  ...
  },
  {
    ...
    role: 'boss',
    level: 12, health: 4367, damage: 43, defense: 31, speed: 76, xp: 1058, gold: [184, 430], radius: 28,
  ...
  },
  {
    ...
    scale: 2.1,
    role: 'boss',
    level: 17, health: 8136, damage: 59, defense: 43, speed: 78, xp: 1948, gold: [298, 695], radius: 26,
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    scale: 2.2,
    role: 'boss',
    level: 19, health: 9995, damage: 65, defense: 48, speed: 80, xp: 2383, gold: [351, 820], radius: 26,
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    role: 'boss',
    level: 24, health: 15477, damage: 80, defense: 61, speed: 74, xp: 3668, gold: [509, 1188], radius: 26,
  ...
  },
  {
    ...
    scale: 2.6,
    role: 'boss',
    level: 28, health: 20793, damage: 93, defense: 71, speed: 66, xp: 4898, gold: [662, 1546], radius: 30,
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    scale: 3.1,
    role: 'boss',
    level: 32, health: 26758, damage: 105, defense: 82, speed: 72, xp: 6308, gold: [842, 1965], radius: 38,
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    level: 30, health: 23616, damage: 99, defense: 77, speed: 122, xp: 5580, gold: [749, 1747], radius: 17,
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    role: 'boss',
    level: 25, health: 16680, damage: 83, defense: 64, speed: 58, xp: 3958, gold: [545, 1272], radius: 36,
  ...
  },
  {
    ...
    scale: 2.7, role: 'boss',
    level: 27, health: 19332, damage: 90, defense: 69, speed: 70, xp: 4573, gold: [622, 1451], radius: 32,
  ...
  },
  {
    ...
    role: 'boss',
    level: 31, health: 25232, damage: 102, defense: 79, speed: 64, xp: 5938, gold: [795, 1854], radius: 40,
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    role: 'boss',
    level: 40, health: 41304, damage: 130, defense: 102, speed: 86, xp: 9668, gold: [1290, 3010], radius: 44,
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    level: 60, health: 91065, damage: 192, defense: 153, speed: 54, xp: 21218, gold: [3019, 7044], radius: 34,
  ...
  },
  {
    ...
    level: 67, health: 112961, damage: 214, defense: 171, speed: 92, xp: 26323, gold: [3860, 9008], radius: 30,
  ...
  },
  {
    ...
    level: 74, health: 137185, damage: 236, defense: 189, speed: 76, xp: 31980, gold: [4839, 11292], radius: 38,
