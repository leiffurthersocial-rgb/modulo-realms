...
export const AEGEAN_ISLAND_ECOLOGY: Record<string, AegeanEcology> = {
  ...
  gorgon: biome(['graeae', 'lamia', 'eidolon'], 'gaze', 'sea-mist', '#abc58d', 'Petrified orchards · leave the watching eye'),
  ...
  sirens: biome(['siren', 'nereid', 'anemoi'], 'song', 'rain', '#aeace3', 'Singing sea stacks · sound rings sweep the rocks'),
  ...
  drowned_lyre: biome(['siren', 'eidolon', 'nereid'], 'song', 'sea-mist', '#b9a1dc', 'Drowned amphitheatre · visible notes become shockwaves'),
