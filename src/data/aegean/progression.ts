...
const surfaceCorrections: Record<string, { tx: number; ty: number }> = {
  ...
  aegean_contract_pass: { tx: 1239, ty: 211 },
  aegean_discovery_split_star: { tx: 1288, ty: 112 },
  aegean_storm_altar: { tx: 1267, ty: 146 },
};
for (const activity of [...AEGEAN_STORIES, ...AEGEAN_DISCOVERIES, ...AEGEAN_CONTRACTS, ...AEGEAN_COMMISSIONS])
