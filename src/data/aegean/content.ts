...
export const AEGEAN_MATERIALS: ItemTemplate[] = [
  ...
  },
  {
    ...
    stats: {},
    noDrop: true,
    desc: "Permanent Stormbreaker component. Its proof is stored in the Chronicle.",
  },
  {
...
export const AEGEAN_RECIPES: AegeanRecipe[] = [
  ...
  recipe("aspis_sparta", "Aspis of Sparta", "aegean_veteran_writ", "baseline"),
...
export const AEGEAN_SHIPS: AegeanShip[] = [
  {
    ...
    requirements: ["aegean_veteran_writ"],
    stormRating: 0,
    cargo: 6,
    draft: "shallow",
    ram: false,
  ...
  },
  {
    ...
    requirements: ["aegean_veteran_writ", "aegean_bull"],
    stormRating: 2,
    cargo: 10,
    draft: "deep",
    ram: true,
