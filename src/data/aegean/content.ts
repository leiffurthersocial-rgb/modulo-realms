...
export const AEGEAN_GEAR: ItemTemplate[] = [
  ...
  weapon(
    ...
    "Royal thrusts cleave a long line. Unleash Royal Counter at will; a timed defence empowers it and restores stamina.",
    { strength: 90, dexterity: 40, vitality: 50, critChance: 28, critDamage: 110, lifesteal: 10 },
  ),
  weapon(
    "last_dawn_kopis",
    "Last Dawn Kopis",
    ...
    66,
    "aegean_dawn_pursuit",
    "Relentless cuts end in a returning blade. The Last Pursuit grants speed and protection; an interrupt magnifies its damage.",
    { dexterity: 100, strength: 60, critChance: 32, critDamage: 125, lifesteal: 12, moveSpeed: 16 },
  ),
  weapon(
    "storm_cleared_bow",
    ...
    480,
    "aegean_storm_shot",
    "Storm arrows pierce and burst, marking prey for 30% more damage. Fire Storm-Cleared Sky at will; marked prey takes an empowered shot.",
    { dexterity: 100, critChance: 32, critDamage: 140, moveSpeed: 18, maxStamina: 180, staminaRegen: 10 },
  ),
  weapon(
    "first_flame_sceptre",
    ...
    405,
    "aegean_flame_cycle",
    "Every cast drives a full-strength flame lance; the fan and ring add erupting embers. Three First Flames burns a devastating path, fan or nova.",
    { intelligence: 110, abilityPower: 140, maxMana: 640, manaRegen: 16, cooldownReduction: 24, critChance: 28, critDamage: 110, lifesteal: 12 },
  ),
  weapon(
    "twin_oathblades",
    "Twin Oathblades",
    ...
    124,
    "aegean_oath_combo",
    "Both oathblades strike nearby prey; the outer chain pulls enemies in. Twin Oath cleaves at will and grows stronger after alternating near and far hits.",
    { dexterity: 100, strength: 60, critChance: 32, critDamage: 120, lifesteal: 12, maxStamina: 180, staminaRegen: 12 },
  ),
  weapon(
    "unbroken_standard",
    ...
    "Sweeping blows command the battlefield. Stand Unbroken erupts around you, restores your reserves and raises a protective rallying ground.",
    { strength: 100, vitality: 70, critChance: 28, critDamage: 115, maxHealth: 500, abilityPower: 60, lifesteal: 10 },
  ),
  offhand(
    "aspis_sparta",
    "Aspis of Sparta",
  ...
  offhand(
    ...
    "Raise a reflecting ward and cleanse petrification at will. A timed brace strengthens the counterstrike; the mirror empowers every fighting style.",
    { defense: 520, maxHealth: 1000, maxStamina: 260, maxMana: 700, strength: 75, dexterity: 75, intelligence: 100, abilityPower: 160, critChance: 32, critDamage: 110, manaRegen: 12, cooldownReduction: 36 },
  ),
  offhand(
    ...
    "An unyielding shield for the last companion. Raise its ward, restore health and strike back; a timed brace makes the counter devastating.",
    { defense: 620, vitality: 100, maxHealth: 1400, maxStamina: 300, strength: 90, dexterity: 75, intelligence: 90, abilityPower: 150, critChance: 32, critDamage: 110, staminaRegen: 14, cooldownReduction: 36 },
  ),
  armour(
    "nemean_mantle",
    "Nemean Mantle",
  ...
  armour(
    ...
    1.5,
    "aegean_oath_guard",
    "The island's supreme panoply. A timed defence grants a powerful ward, restores health and stamina, and clears slowing effects. Execution mechanics remain lethal.",
    { vitality: 100, maxHealth: 1800, maxMana: 420, maxStamina: 340, strength: 75, dexterity: 75, intelligence: 85, abilityPower: 120, critChance: 32, critDamage: 100, cooldownReduction: 28, moveSpeed: 25, manaRegen: 12, staminaRegen: 14 },
    "heavy",
  ),
  artifact(
    "ariadne_thread",
  ...
  artifact(
    ...
    "mat_essence",
    "aegean_ember_oath",
    "The first oath answers whenever called: a searing eruption, immense ability power, protection and renewed resources. An earned interrupt empowers its eruption.",
    { strength: 80, intelligence: 80, dexterity: 80, vitality: 60, defense: 240, abilityPower: 140, critChance: 30, critDamage: 110, maxHealth: 900, maxMana: 420, maxStamina: 300, manaRegen: 14, staminaRegen: 14, cooldownReduction: 45 },
  ),
];
