...
export default function CrownPanel({ game }: { game: Game }) {
  ...
  return (
    <Modal title={<>The Crown&apos;s Ledger</>} sub={<>{p.gold.toLocaleString()} gold</>} size="l" tall onClose={() => game.closeAll()}>

        <div className="inv-col scroll" style={{ overflowY: 'auto', flex: 1, padding: '0 8px 6px' }}>
          ...
          {rows.length === 0 ? (
            <div style={{ color: 'var(--muted)', padding: '7px 1px' }}>
              ...
              <div key={loc.id} className="crown-row">
                ...
                <div className="cr-actions">
                  {bossDown && d.boss ? (
                    ...
                    >
                      <img src={getIconUrl('skull')} alt="" style={{ width: 7, height: 7, verticalAlign: -2, marginRight: 2 }} />
