...
- The Three Hundred are all present on one earth battlefield from the start. Spatial steering and four concurrent attack commitments bound simulation and warning noise; these are not reinforcement waves. Completed victories stay completed; unfinished old chapter saves restart the simultaneous battle.
